...
<h2>${esc(kw)}, 무엇을 확인해야 하나요?</h2><ul><li><strong>시세 공개 여부</strong>: 매입가·판매가를 돈·g 단위로 공개하는지. 문강금은은 <a href="/price">시세표</a>를 매일 갱신합니다.</li><li><strong>감정 방식</strong>: 고객이 보는 앞에서 저울과 시금석으로 확인하는지. <a href="/guide/appraisal">감정 안내</a></li><li><strong>현금 지급·재매입</strong>: 매입은 현장 현금, 판매 제품은 되팔 때 당일 매입 시세 적용.</li><li><strong>위치·시간</strong>: 종로3가역 11번 출구 앞, ${esc(s.hours)}.</li></ul>
