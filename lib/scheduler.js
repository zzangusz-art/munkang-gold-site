...
function start({ audit } = {}) {
  ...
  console.log(`[scheduler] 시작 — 콘텐츠 슬롯 ${slots().join(', ')} (KST), 국제시세 08:30·13:30, 주간 리포트 매주 킥오프 요일 08:30, 감사 매일 07:00`);
}
function status() {
  const date = kstDate();
