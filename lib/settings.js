...
const DEFAULTS = {
  site_url: process.env.SITE_URL || 'https://www.munkanggold.com',
  site_name: '문강금은',
  legal_name: '문강금은',
  ...
  email: '',
  address: '서울특별시 종로구 종로3가 (종로3가역 11번 출구 앞)',
  address_detail: '',            // 예: 한국주얼리랜드 2층 — 담당자 확인 후 입력
  region_text: '종로3가역 11번 출구 앞',
  biz_no: '',
  ceo: '',
  privacy_officer: '',
  founded: '',
  ...
  // 시세·가격 계산
  quote_note: '시세는 한국금거래소 고시가를 기준으로 실시간 반영되며 국제 금시세와 환율에 따라 하루 중에도 바뀝니다. 실제 거래가는 감정 결과(순도, 중량, 상태)에 따라 정해집니다.',
  ...
  quote_source: 'live',           // live=한국금거래소 고시가 실시간 크롤링 반영 · spot=국제시세 환산 · manual=직접 입력
