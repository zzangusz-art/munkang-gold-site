...
<header class="header" id="header">
  <div class="topbar"><div class="wrap"><span>📍 종로3가역 11번 출구 앞 · ${esc(s.hours)}</span><span class="tb-right"><a href="${attr(s.kakao_channel)}" target="_blank" rel="noopener">오픈채팅</a><a href="${attr(s.naver_place)}" target="_blank" rel="noopener">네이버 플레이스</a><a href="${attr(s.instagram)}" target="_blank" rel="noopener">인스타그램</a><a href="/about/location">오시는 길</a></span></div></div>
