...
<section class="cta-band"><div class="wrap cta-inner"><div><h2>금을 팔 때도, 살 때도 종로3가 문강금은</h2><p>종로3가 매장에서 30분 이내 정밀 감정 후 현장 현금 지급. 거동이 불편하거나 수량이 많으면 출장 매입으로 찾아갑니다. 골드바·실버바·돌반지는 당일 시세로 구매하실 수 있습니다.</p></div><div class="cta-actions"><a class="btn btn-light" href="tel:${attr(s.phone)}">${esc(s.phone)}</a><a class="btn btn-gold" href="/apply">매입·구매 예약</a><a class="btn btn-kakao" href="${attr(s.kakao_channel)}" target="_blank" rel="noopener">카카오톡 상담</a></div></div></section>
<footer class="footer">
